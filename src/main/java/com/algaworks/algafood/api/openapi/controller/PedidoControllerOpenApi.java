...
public interface PedidoControllerOpenApi {
	...
	public RepresentationModel<PedidoModel> buscar(@ApiParam(example = "f9981ca4-5a5e-4da3-af04-933861df3e55", value="Código do pedido", required = true) String codigo);
